...
namespace Forge.Identity.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyncState = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DirectoryLinks", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectoryLinks_Provider_ExternalId",
                schema: "identity",
